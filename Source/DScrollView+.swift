...
extension UIView {
    ...
    @discardableResult
    public func edgeTo(_ view: UIView, safeArea: VLViewSafeArea = .none) -> UIView {
    ...
    @discardableResult
    public func addScrollView(_ scrollView: VLScrollView, withSafeArea: VLViewSafeArea = .none, hasStatusBarCover: Bool = false, statusBarBackgroundColor: UIColor = .white, container: VLScrollViewContainer, elements: UIView...) -> UIView {
